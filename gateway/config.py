    ...
    try:
        ...
        if config_yaml_path.exists():
            ...
            for plat in _shared_loop_targets:
                ...
                if plat in {Platform.DISCORD, Platform.SLACK} and "channel_runtime_bindings" in platform_cfg:
                    bridged["channel_runtime_bindings"] = platform_cfg["channel_runtime_bindings"]
